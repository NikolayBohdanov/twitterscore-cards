...
const themes = {
  light: {
    ...
    tagBorder: "#E5E7EB",
    smartBadgeBg: "#EFF6FF",
    smartBadgeText: "#2563EB",
    smartBadgeBorder: "#DBEAFE",
  },
  dark: {
    background: "#121212",
    cardBg: "#1E1E1E",
    ...
    smartBadgeBg: "rgba(34,197,94,0.1)",
    smartBadgeText: "#22C55E",
    smartBadgeBorder: "rgba(34,197,94,0.2)",
  },
};
...
const SmartDropCardV4 = forwardRef<HTMLDivElement, Props>(
              ...
              return (
                ...
                >
                  ...
                  >
                    <span
                      style={{
                        background: t.smartBadgeBg,
                        color: t.smartBadgeText,
                        border: `1px solid ${t.smartBadgeBorder}`,
                        padding: "3px 12px",
                        borderRadius: 10,
                        fontSize: 12,
                        fontWeight: 700,
                    ...
                    >
                      {(acc.smartFollowers || 0).toLocaleString()}
                    </span>
                  </div>
...
SmartDropCardV4.displayName = "SmartDropCardV4";
export default SmartDropCardV4;
