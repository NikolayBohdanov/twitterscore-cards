...
import SmartDropCard, { AccountData } from "@/components/SmartDropCard";
...
export default function Home() {
  ...
  const fetchAccounts = async () => {
    ...
    try {
      ...
      // Sort by score descending (create new array to avoid mutation)
  ...
  const downloadPng = useCallback(async () => {
    ...
    try {
      ...
      link.download = `smart-drop-week-${weekNumber}.png`;
      link.href = dataUrl;
      link.click();
    } catch {
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          {error && (
            <div
              style={{ color: "#FF5F57", marginTop: 12, fontSize: 13 }}
            >
              {error}
            </div>
          )}
